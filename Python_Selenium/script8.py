...
dropdown_animals = Select(browser.find_element(By.XPATH, "//select[@id='second']"))
dropdown_animals.select_by_visible_text("Pizza")
time.sleep(5)
dropdown_animals.select_by_visible_text("Bonda")